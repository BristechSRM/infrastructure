module Credentials
    ...
    let missingCredentialsMessage = "TrelloKey or TrelloToken is unset. Create a TrelloCreds.config file next to the App.config with the following xml (Filling in the key and token value fields):" + credConfigTemplate
